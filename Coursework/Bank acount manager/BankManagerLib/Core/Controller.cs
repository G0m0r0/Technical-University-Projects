namespace BankManagerLib.Core
{
    ...
    using BankManagerLib.Core.Contracts;
    using BankManagerLib.Repositories;
    using BankManagerLib.Models.Person.Contracts;
    using BankManagerLib.Models.Accounts.Contracts;
    using BankManagerLib.Repositories.Contracts;
    using BankManagerLib.Models.Person;
    using BankManagerLib.Models.Accounts;
