...
public class StartUpDerivatives {
     ...
     */
    private static DoubleFunction<Double> derive(DoubleFunction<Double> f1,DoubleFunction<Double> f2) {
        return (x,y) -> (Math.pow(x-3, 2)+Math.pow(y-4,2)-10) / DX;
    }
